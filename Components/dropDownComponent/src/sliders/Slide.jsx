...
const Slide = ({ slides }) => {
  ...
  const slideEl = slides.map((slide) => (
    <motion.div
      key={slide.id}
      className="relative grid gap-2 place-items-center text-center shadow-lg pb-12 p-4 bg-white my-10 min-w-full md:min-w-[49%] lg:min-w-[32%]"
    >
  ...
  return (
    <motion.div 
      ref={carousel}
       className="no-scrollbar relative overflow-x-hidden">
        <motion.div
          drag= 'x'
...
{/* <div
onClick={slideRight}
className="absolute font-bold text-4xl absolute-right opacity-60 cursor-pointer"
>
&#10217;
</div>
<div
onClick={slideLeft}
className="absolute font-bold text-4xl absolute-left opacity-60 cursor-pointer"
>
&#12296;
</div> */}